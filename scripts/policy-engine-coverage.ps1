...
$resultsDirectory = Join-Path $repositoryRoot ".decisionforge/coverage/policy-engine/$runName"
...
node (Join-Path $PSScriptRoot 'check-policy-engine-coverage.mjs') $coverageFile.FullName
exit $LASTEXITCODE
