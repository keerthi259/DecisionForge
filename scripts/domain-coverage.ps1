...
$resultsDirectory = Join-Path $repositoryRoot ".decisionforge/coverage/domain/$runName"
...
node (Join-Path $PSScriptRoot 'check-domain-coverage.mjs') $coverageFile.FullName
exit $LASTEXITCODE
