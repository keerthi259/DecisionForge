...
results_dir=".decisionforge/coverage/application/$run_name"
project="tests/DecisionForge.Application.UnitTests/DecisionForge.Application.UnitTests.csproj"
...
"$node_command" scripts/check-application-coverage.mjs "$coverage_file"
popd >/dev/null
